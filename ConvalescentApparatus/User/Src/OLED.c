...
#define SOFTWARE_I2C //HARDWARE_I2C  HARDWARE_I2C_DMA SOFTWARE_I2C

#ifdef HARDWARE_I2C
#include "i2c.h"
#define I2CHandle hi2c1   //使用的硬件I2C

#endif

#ifdef HARDWARE_I2C_DMA
#include "i2c.h"
#define I2CHandle hi2c2   //使用的硬件I2C
...
void OLED_WriteCommand(uint8_t Command)
{
    ...
    HAL_I2C_Master_Transmit_DMA(&I2CHandle,0x78,TxData,2);
    while(HAL_I2C_GetState(&I2CHandle) == HAL_I2C_STATE_BUSY_TX);
    ...
    HAL_I2C_Master_Transmit(&I2CHandle,0x78,(uint8_t*)TxData,2,10);
#endif
